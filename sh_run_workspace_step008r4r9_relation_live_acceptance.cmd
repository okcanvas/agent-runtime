...
"okcanvas-agent-runtime\.venv\Scripts\python.exe" scripts\workspace_python_bytecode_isolation.py scripts\run_workspace_step008r4r9_relation_live_entrypoint.py %*
exit /b %ERRORLEVEL%
