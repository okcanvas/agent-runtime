...
from workspace_process import decode_process_output, render_json_for_console, resolve_executable, run_process, workspace_root_errors, write_json_stdout

STEP = "WORKSPACE_STEP003R1_WINDOWS_CP949_PARENT_JSON_OUTPUT_CLOSURE"
VERSION = "0.3.1"
OUTPUT_DEFAULT = ROOT / "docs/evidence/WORKSPACE_STEP003R1_ACCEPTANCE.json"
...
def failure(started: str, errors: list[str]) -> dict[str, Any]:
    return {
        "schema_version": "okcanvas-agent-platform-workspace-step003r1-acceptance-v1",
        "step": STEP,
        "version": VERSION,
...
def run(output: Path) -> int:
    ...
    checks = {
        ...
        "current_step003r1_windows_not_claimed": parsed["runtime"] is not None
        ...
        "step003r1_launcher_present": (ROOT / "sh_run_workspace_step003r1_acceptance.cmd").is_file(),
