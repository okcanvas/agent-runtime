...
MUTABLE_ACCEPTANCE_EVIDENCE = {
    ...
    "docs/evidence/WORKSPACE_STEP008R4R8_ACCEPTANCE.json",
    ...
    "docs/evidence/WORKSPACE_STEP008R4R12R2_GROUNDED_STRUCTURED_DELEGATION_LIVE_ACCEPTANCE.json",
    "docs/evidence/WORKSPACE_STEP008R4R12R3_GROUNDED_STRUCTURED_DELEGATION_LIVE_ACCEPTANCE.json",
    "docs/evidence/WORKSPACE_STEP008R4R12R4_GROUNDED_STRUCTURED_DELEGATION_LIVE_ACCEPTANCE.json",
