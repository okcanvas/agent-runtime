...
STEP = "WORKSPACE_STEP001R3_LOCAL_ENVIRONMENT_AND_TEST_IMPORT_BOUNDARY_CLOSURE"
VERSION = "0.1.3"
OUTPUT = ROOT / "docs/evidence/WORKSPACE_STEP001R3_ACCEPTANCE.json"
...
def failure_payload(started: str, errors: list[str]) -> dict[str, Any]:
    ...
    return {
        "schema_version": "okcanvas-agent-platform-workspace-step001r3-acceptance-v1",
        "step": STEP,
        "version": VERSION,
        "state": "FAILED",
        "started_at": started,
