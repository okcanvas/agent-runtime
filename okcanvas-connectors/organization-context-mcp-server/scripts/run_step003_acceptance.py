...
def main() -> int:
    ...
    checks = {
        ...
        "get_entity_relation_completeness_contract": binding.get("get_entity_relation_completeness_required") is True and api.get("get_entity_relation_completeness_required") is True and binding.get("get_entity_relation_completeness_fields") == ["relation_count", "relations_returned_count", "relations_truncated"] and api.get("get_entity_relation_completeness_fields") == ["relation_count", "relations_returned_count", "relations_truncated"] and "ORGANIZATION_CONTEXT_RELATION_COMPLETENESS_INVALID" in source and "relation_count" in source and "relations_returned_count" in source and "relations_truncated" in source,
    ...
    payload = {
        "schema_version": "okcanvas-organization-context-connector-step003-acceptance-v1",
    ...
    output = ROOT / "docs/evidence/CONNECTOR_ORGANIZATION_CONTEXT_STEP003_ACCEPTANCE.json"
