...
set "PYTHON_EXE=okcanvas-agent-runtime\.venv\Scripts\python.exe"
if not exist "%PYTHON_EXE%" (
  echo [ERROR] Runtime environment is missing. Run sh_setup_workspace.cmd first.
  exit /b 2
)
"%PYTHON_EXE%" scripts\run_workspace_step001r3_acceptance.py
exit /b %ERRORLEVEL%
