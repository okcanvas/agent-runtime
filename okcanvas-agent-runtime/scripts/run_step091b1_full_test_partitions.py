...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step091b1-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP091B1_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 12
STEP = "STEP091B1_TYPED_PERSISTENCE_PORTS_AND_TRANSACTION_OWNERSHIP"
SCHEMA_VERSION = "okcanvas-step091b1-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step091b1-runtime-test-partition-v1",
        "step": STEP,
