...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step091b3-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP091B3_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 12
STEP = "STEP091B3_POSTGRESQL_APPROVAL_EVALUATION_AND_SESSION_METADATA"
SCHEMA_VERSION = "okcanvas-step091b3-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step091b3-runtime-test-partition-v1",
        "step": STEP,
