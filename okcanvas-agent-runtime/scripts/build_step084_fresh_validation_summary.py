...
def build(
    *,
    ...
    evidence = {
        ...
        "organization_context": _load(organization_context_path),
    ...
    with zipfile.ZipFile(candidate_zip) as archive:
        ...
        forbidden = sorted(
            ...
            or "/docs/evidence/step084-local/" in name
        )
    ...
    checks = {
        ...
        "organization_context_passed": evidence["organization_context"].get("state") == "PASSED"
        and evidence["organization_context"].get("passed_checks") == evidence["organization_context"].get("total_checks") == 20,
    ...
    payload = {
        "schema_version": "okcanvas-step084-fresh-zip-validation-v1",
        "step": STEP,
        "version": VERSION,
...
def main() -> int:
    ...
    parser.add_argument("--organization-context", type=Path, required=True)
    ...
    payload = build(
        ...
        organization_context_path=args.organization_context.resolve(),
