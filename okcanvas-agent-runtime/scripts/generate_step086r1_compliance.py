...
OUTPUT = ROOT / "docs/evidence/STEP086R1_CONSTITUTION_COMPLIANCE.json"
VALIDATION_OUTPUT = ROOT / "docs/evidence/STEP086R1_COMPLIANCE_VALIDATION.json"
...
COMMON_EVIDENCE = [
    "docs/evidence/STEP086_WINDOWS_DETERMINISTIC_ACCEPTANCE.json",
    "docs/evidence/STEP086R1_ARCHITECTURE_VALIDATION.json",
    "docs/evidence/STEP086R1_GROUPWARE_BOUNDARY_VALIDATION.json",
    "docs/evidence/STEP086R1_EXECUTION_PLANE_VALIDATION.json",
    "docs/evidence/STEP086R1_DISTRIBUTION_VALIDATION.json",
    "docs/evidence/STEP086R1_PYTHON_REGRESSION.json",
    "docs/evidence/STEP086R1_NON_PYTHON_VALIDATION.json",
    "docs/evidence/STEP086R1_INSTALLATION_VALIDATION.json",
    "docs/evidence/STEP086R1_WINDOWS_SUBPROCESS_PORTABILITY_VALIDATION.json",
    "docs/evidence/STEP086R1_ACCEPTANCE.json",
]
ISSUES = [f"OR-ISSUE-{number:03d}" for number in range(17, 95)]
...
def generate(output: Path = OUTPUT) -> dict[str, Any]:
    ...
    evidence = {
        ...
        "GATE-AMENDMENT-VALID": "constitution unchanged; STEP086R1 corrects the internal Sub-agent/external MCP provider boundary and adds a strict read-only output contract",
        "GATE-NO-UNCLASSIFIED-TOPLEVEL-PACKAGE": "STEP086R1 Architecture 40/40",
        "GATE-NO-HARDCODED-OLD-PACKAGE-PATH": "executable legacy path coupling remains zero",
        "GATE-WHEEL-CONTENTS-EXACT": "STEP086R1 Installation 16/16 and exact 351-file wheel payload PASS",
        "GATE-EDITABLE-INSTALL": "STEP086R1 editable install and entrypoint PASS",
        ...
        "GATE-LAUNCHER-REGISTRY-COMPLETE": "STEP086R1 launcher registry v2 7/7",
        ...
        "GATE-FULL-REGRESSION": "STEP086R1 Python 973/973 and Node 14/14 PASS",
        "GATE-WINDOWS-LIVE": "STEP086 Windows deterministic 14/14 accepted; STEP086R1 Windows deterministic rerun remains external",
        "GATE-FRESH-ZIP": "STEP086R1 source tree is ready for final immutable Fresh ZIP verification",
        "GATE-ISSUE-REGISTRY-COMPLETE": "OR-ISSUE-017 through OR-ISSUE-094 retained with recurrence gates",
    }
    gate_results = [
    ...
    traceability = [
        {
            ...
            "acceptance_checks": [
                "STEP086 Windows deterministic 14/14",
                "STEP086R1 Architecture 40/40",
                "STEP086R1 Groupware boundary 25/25",
                "STEP086R1 integrated acceptance 13/13",
                "STEP086R1 Python full regression 973/973",
            ],
    ...
    payload: dict[str, Any] = {
        ...
        "validation_environment": {
            ...
            "step086_windows_deterministic": "ACCEPTED_14_OF_14",
            "step086r1_windows_deterministic": "PENDING_EXTERNAL_PRODUCT_PROMOTION_GATE",
