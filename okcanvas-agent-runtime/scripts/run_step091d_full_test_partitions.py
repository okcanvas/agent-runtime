...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step091d-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP091D_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 18
STEP = "STEP091D_OBJECT_STORAGE_DEPLOYMENT_COMPOSITION_AND_LIVE_ACCEPTANCE_GATE"
SCHEMA_VERSION = "okcanvas-step091d-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step091d-runtime-test-partition-v1",
        "step": STEP,
