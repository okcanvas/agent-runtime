...
OUTPUT = ROOT / "docs/evidence/STEP083_CONSTITUTION_COMPLIANCE.json"
VALIDATION_OUTPUT = ROOT / "docs/evidence/STEP083_COMPLIANCE_VALIDATION.json"
...
COMMON_IMPLEMENTATION = [
    ...
    "scripts/validate_step083_assistant_routing.py",
...
COMMON_EVIDENCE = [
    ...
    "docs/evidence/STEP083_ARCHITECTURE_VALIDATION.json",
    "docs/evidence/STEP083_ASSISTANT_ROUTING_VALIDATION.json",
    "docs/evidence/STEP083_EXECUTION_PLANE_VALIDATION.json",
    "docs/evidence/STEP083_DISTRIBUTION_VALIDATION.json",
    "docs/evidence/STEP083_PYTHON_REGRESSION.json",
    "docs/evidence/STEP083_NON_PYTHON_VALIDATION.json",
    "docs/evidence/STEP083_INSTALLATION_VALIDATION.json",
    "docs/evidence/STEP083_WINDOWS_SUBPROCESS_PORTABILITY_VALIDATION.json",
    "docs/evidence/STEP083_ACCEPTANCE.json",
    "docs/evidence/STEP083_FRESH_ZIP_VALIDATION.json",
]
ISSUES = [f"OR-ISSUE-{number:03d}" for number in range(17, 71)]
...
def generate(output: Path = OUTPUT) -> dict[str, Any]:
    ...
    evidence = {
        ...
        "GATE-AMENDMENT-VALID": "constitution text unchanged; STEP083 adds Agent-ID-free Assistant routing without new external authority",
        "GATE-NO-UNCLASSIFIED-TOPLEVEL-PACKAGE": "STEP083 Architecture 40/40",
        "GATE-NO-HARDCODED-OLD-PACKAGE-PATH": "executable legacy path coupling remains zero",
        "GATE-WHEEL-CONTENTS-EXACT": "STEP083 Installation 16/16, wheel payload 335 files",
        "GATE-EDITABLE-INSTALL": "STEP083 fresh editable install and entrypoint PASS",
        ...
        "GATE-LAUNCHER-REGISTRY-COMPLETE": "STEP083 launcher registry v2 7/7",
        ...
        "GATE-FULL-REGRESSION": "STEP083 Python full regression and Node 14/14 PASS",
        "GATE-WINDOWS-LIVE": "inherited STEP081D Windows live 80/80; STEP083 adds no live authority",
        "GATE-FRESH-ZIP": "STEP083 Fresh ZIP validation PASS",
        "GATE-ISSUE-REGISTRY-COMPLETE": "OR-ISSUE-017 through OR-ISSUE-070 retained with recurrence gates",
    }
    ...
    traceability = [
        {
            ...
            "acceptance_checks": [
                ...
                "STEP083 Architecture 40/40",
                "STEP083 Assistant routing 18/18",
                "STEP083 integrated acceptance PASS",
                "STEP083 full and Fresh regression PASS",
            ],
    ...
    payload: dict[str, Any] = {
        ...
        "validation_environment": {
            ...
            "step083_windows_deterministic": "PENDING_EXTERNAL_PRODUCT_PROMOTION_GATE",
