...
OUTPUT = ROOT / "docs/evidence/STEP086_CONSTITUTION_COMPLIANCE.json"
VALIDATION_OUTPUT = ROOT / "docs/evidence/STEP086_COMPLIANCE_VALIDATION.json"
...
COMMON_IMPLEMENTATION = [
    ...
    "okcanvas_agent_runtime/application/groupware_read/models.py",
    "okcanvas_agent_runtime/application/groupware_read/catalog.py",
    "okcanvas_agent_runtime/application/assistant_routing/catalog.py",
...
COMMON_EVIDENCE = [
    "docs/evidence/STEP085_WINDOWS_DETERMINISTIC_ACCEPTANCE.json",
    "docs/evidence/STEP086_ARCHITECTURE_VALIDATION.json",
    "docs/evidence/STEP086_GROUPWARE_READ_ONLY_VALIDATION.json",
    "docs/evidence/STEP086_EXECUTION_PLANE_VALIDATION.json",
    "docs/evidence/STEP086_DISTRIBUTION_VALIDATION.json",
    "docs/evidence/STEP086_PYTHON_REGRESSION.json",
    "docs/evidence/STEP086_NON_PYTHON_VALIDATION.json",
    "docs/evidence/STEP086_INSTALLATION_VALIDATION.json",
    "docs/evidence/STEP086_WINDOWS_SUBPROCESS_PORTABILITY_VALIDATION.json",
    "docs/evidence/STEP086_ACCEPTANCE.json",
]
ISSUES = [f"OR-ISSUE-{number:03d}" for number in range(17, 92)]
...
def generate(output: Path = OUTPUT) -> dict[str, Any]:
    ...
    evidence = {
        ...
        "GATE-AMENDMENT-VALID": "constitution unchanged; STEP086 adds one bounded fail-closed Groupware read-only vertical",
        "GATE-NO-UNCLASSIFIED-TOPLEVEL-PACKAGE": "STEP086 Architecture 40/40",
        "GATE-NO-HARDCODED-OLD-PACKAGE-PATH": "executable legacy path coupling remains zero",
        "GATE-WHEEL-CONTENTS-EXACT": "STEP086 Installation 16/16 and exact 350-file wheel payload PASS",
        "GATE-EDITABLE-INSTALL": "STEP086 editable install and entrypoint PASS",
        ...
        "GATE-LAUNCHER-REGISTRY-COMPLETE": "STEP086 launcher registry v2 7/7",
        ...
        "GATE-FULL-REGRESSION": "STEP086 Python 962/962 and Node 14/14 PASS",
        "GATE-WINDOWS-LIVE": "STEP085 Windows deterministic 12/12 retained; STEP086 Windows deterministic rerun remains external",
        "GATE-FRESH-ZIP": "STEP086 source tree is ready for final immutable Fresh ZIP verification",
        "GATE-ISSUE-REGISTRY-COMPLETE": "OR-ISSUE-017 through OR-ISSUE-091 retained with recurrence gates",
    }
    gate_results = [
    ...
    traceability = [
        {
            ...
            "acceptance_checks": [
                "STEP085 Windows deterministic 12/12",
                "STEP086 Architecture 40/40",
                "STEP086 Groupware read-only 30/30",
                "STEP086 integrated acceptance 14/14",
                "STEP086 Python full regression 962/962",
            ],
    ...
    payload: dict[str, Any] = {
        ...
        "validation_environment": {
            ...
            "step085_windows_deterministic": "ACCEPTED_12_OF_12",
            "step086_windows_deterministic": "PENDING_EXTERNAL_PRODUCT_PROMOTION_GATE",
