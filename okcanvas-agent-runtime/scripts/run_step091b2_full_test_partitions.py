...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step091b2-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP091B2_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 12
STEP = "STEP091B2_POSTGRESQL_PRODUCT_AND_SUBMISSION_ATOMIC_STORE"
SCHEMA_VERSION = "okcanvas-step091b2-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step091b2-runtime-test-partition-v1",
        "step": STEP,
