    ...
    *,
    ...
    with zipfile.ZipFile(candidate_zip) as archive:
        ...
        forbidden = sorted(
            ...
            or "/docs/evidence/step082b-local/" in name
        )
    ...
    checks = {
        ...
        and evidence["portability"].get("passed_checks") == evidence["portability"].get("total_checks") == 9,
    ...
    payload = {
        "schema_version": "okcanvas-step082b-fresh-zip-validation-v1",
        "step": STEP,
        "version": VERSION,
