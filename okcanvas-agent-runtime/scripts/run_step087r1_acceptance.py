...
STEP = "STEP087R1_MAIN_ASSISTANT_LIVE_AGENT_TOOL_TURN_BUDGET_CLOSURE"
VERSION = "2.67.1"
OUTPUT_DEFAULT = ROOT / "docs/evidence/STEP087R1_DETERMINISTIC_ACCEPTANCE.json"
STEP087_PARENT = ROOT / "docs/evidence/STEP087_DETERMINISTIC_ACCEPTANCE.json"
...
def run(output: Path) -> int:
    ...
    parent = json.loads(STEP087_PARENT.read_text(encoding="utf-8"))
    ...
    checks = {
        ...
        "step087_parent_retained": parent.get("state") == "PASSED"
        and parent.get("passed_checks") == parent.get("total_checks") == 15,
        ...
        "current_windows_acceptance_not_claimed": getattr(
            info, "step087r1_windows_deterministic_accepted", False
        ) is False,
    }
    payload = {
        "schema_version": "okcanvas-step087r1-deterministic-acceptance-v1",
        "step": STEP,
        "version": VERSION,
        ...
        "limitations": {
            ...
            "windows_step087r1_executed": False,
        },
    }
