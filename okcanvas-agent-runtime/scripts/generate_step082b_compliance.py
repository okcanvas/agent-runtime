...
OUTPUT = ROOT / "docs/evidence/STEP082B_CONSTITUTION_COMPLIANCE.json"
VALIDATION_OUTPUT = ROOT / "docs/evidence/STEP082B_COMPLIANCE_VALIDATION.json"
...
COMMON_EVIDENCE = [
    ...
    "docs/evidence/STEP082B_ARCHITECTURE_VALIDATION.json",
    "docs/evidence/STEP082B_EXECUTION_PLANE_VALIDATION.json",
    "docs/evidence/STEP082B_DISTRIBUTION_VALIDATION.json",
    "docs/evidence/STEP082B_PYTHON_REGRESSION.json",
    "docs/evidence/STEP082B_NON_PYTHON_VALIDATION.json",
    "docs/evidence/STEP082B_INSTALLATION_VALIDATION.json",
    "docs/evidence/STEP082B_WINDOWS_SUBPROCESS_PORTABILITY_VALIDATION.json",
    "docs/evidence/STEP082B_ACCEPTANCE.json",
    "docs/evidence/STEP082B_FRESH_ZIP_VALIDATION.json",
]
ISSUES = [f"OR-ISSUE-{number:03d}" for number in range(17, 62)]
...
def generate(output: Path = OUTPUT) -> dict[str, Any]:
    ...
    evidence = {
        ...
        "GATE-AMENDMENT-VALID": "constitution text unchanged; STEP082B adds Product boundary policies only",
        "GATE-NO-UNCLASSIFIED-TOPLEVEL-PACKAGE": "STEP082B Architecture 40/40",
        "GATE-NO-HARDCODED-OLD-PACKAGE-PATH": "executable legacy path coupling remains zero",
        "GATE-WHEEL-CONTENTS-EXACT": "STEP082B Installation 16/16, wheel payload 335 files",
        "GATE-EDITABLE-INSTALL": "STEP082B fresh editable install and entrypoint PASS",
        ...
        "GATE-BOOTSTRAP-WIRING-ONLY": "GenericAgentExecutionService is sole Product control plane",
        ...
        "GATE-LAUNCHER-REGISTRY-COMPLETE": "STEP082B launcher registry v2 7/7",
        ...
        "GATE-FULL-REGRESSION": "STEP082B Python full regression and Node 14/14 PASS",
        "GATE-WINDOWS-LIVE": "inherited STEP081D Windows live 80/80; STEP082B adds no live authority",
        "GATE-FRESH-ZIP": "STEP082B Fresh ZIP validation PASS",
        "GATE-ISSUE-REGISTRY-COMPLETE": "OR-ISSUE-017 through OR-ISSUE-061 retained with recurrence gates",
    }
    ...
    traceability = [
        {
            ...
            "acceptance_checks": [
                ...
                "STEP082B Architecture 40/40",
                "STEP082B integrated acceptance PASS",
                "STEP082B full and Fresh regression PASS",
            ],
    ...
    payload: dict[str, Any] = {
        ...
        "validation_environment": {
            ...
            "step082b_windows_deterministic": "PENDING_EXTERNAL_PRODUCT_PROMOTION_GATE",
