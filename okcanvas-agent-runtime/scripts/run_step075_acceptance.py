...
OUTPUT_DEFAULT = ROOT / "docs/evidence/STEP075_ACCEPTANCE.json"
STEP = "STEP075_PRODUCT_OWNED_READ_ONLY_SANDBOX_WORKSPACE_AGENT_V1"
VERSION = "2.55.0"
...
def run(output: Path) -> int:
    ...
    deterministic_launcher = (ROOT / "sh_run_step075_acceptance.cmd").read_text(encoding="utf-8")
    live_launcher = (ROOT / "sh_run_step075_live_acceptance.cmd").read_text(encoding="utf-8")
    ...
    compile_ok, compile_output = run_command(
        [
            ...
            "-q",
            "src",
            "scripts/run_step075_acceptance.py",
            "scripts/run_step075_live_acceptance.py",
        ],
        ROOT,
    )
    ...
    required_docs = (
        ROOT / "docs/plans/STEP075_PRODUCT_OWNED_READ_ONLY_SANDBOX_WORKSPACE_AGENT_V1.md",
        ROOT / "docs/reference/STEP075_PRODUCT_OWNED_READ_ONLY_SANDBOX_WORKSPACE_AGENT_V1_CODE_AUDIT.md",
        ROOT / "docs/evidence/STEP074_WINDOWS_LIVE_ACCEPTANCE_SUMMARY.json",
    ...
    checks = {
        ...
        "step075_runtime_flags_exact": (
            ...
            and info.next_selected_step == "UNSELECTED_PENDING_STEP075_WINDOWS_LIVE_ACCEPTANCE"
        ),
        ...
        "service_metadata_and_policy_select_step075_gate": (
            service_policy.get("next_selected_step") == "UNSELECTED_PENDING_STEP075_WINDOWS_LIVE_ACCEPTANCE"
        ...
        "windows_launchers_use_isolation_and_data_loader": (
            "python_bytecode_isolation.py scripts\\run_step075_acceptance.py" in deterministic_launcher
            and "python_bytecode_isolation.py scripts\\windows_entrypoint.py readonly-sandbox-workspace-live-acceptance" in live_launcher
            and "readonly-sandbox-workspace-live-acceptance" in windows_entrypoint
            and "run_step075_live_acceptance.py" in windows_entrypoint
        ),
        ...
        "step075_documents_present": all(path.is_file() for path in required_docs),
        "focused_step075_tests_pass": focused_ok,
        ...
        "source_package_default_is_step075": (
            "step075-product-owned-read-only-sandbox-workspace-agent-v1" in package_source
            and "STEP075_PRODUCT_OWNED_READ_ONLY_SANDBOX_WORKSPACE_AGENT_V1" in package_source
        ),
    }
    payload = {
        "schema_version": "okcanvas-step075-acceptance-v1",
        "step": STEP,
        "version": VERSION,
        ...
        "model_calls": 0,
        "live_launcher": "sh_run_step075_live_acceptance.cmd",
