...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step092-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP092_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 18
STEP = "STEP092_SESSION_CONTEXTUAL_FOLLOW_UP_AND_STABLE_ENTITY_FOCUS"
SCHEMA_VERSION = "okcanvas-step092-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step092-runtime-test-partition-v1",
        "step": STEP,
