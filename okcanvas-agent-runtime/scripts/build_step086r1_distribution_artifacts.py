...
def build(*, runtime: Path, configuration: Path, reference: Path, output: Path) -> dict[str, Any]:
    ...
    checks = {
        ...
        "runtime_has_windows_launcher": _zip_has(runtime, "okcanvas-agent-runtime/sh_run_step086r1_acceptance.cmd"),
        ...
        "runtime_filename_matches_current_sot": runtime.name == "okcanvas-agent-runtime-step086r1-groupware-subagent-and-external-mcp-boundary-alignment.zip",
    }
    payload = {
        "schema_version": "okcanvas-step086r1-final-distribution-artifacts-v1",
        "step": STEP,
        "version": VERSION,
