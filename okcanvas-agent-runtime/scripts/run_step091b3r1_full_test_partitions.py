...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step091b3r1-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP091B3R1_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 18
STEP = "STEP091B3R1_REAL_POSTGRESQL_LIVE_ACCEPTANCE_GATE"
SCHEMA_VERSION = "okcanvas-step091b3r1-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step091b3r1-runtime-test-partition-v1",
        "step": STEP,
