...
OUTPUT = ROOT / "docs/evidence/STEP084_CONSTITUTION_COMPLIANCE.json"
VALIDATION_OUTPUT = ROOT / "docs/evidence/STEP084_COMPLIANCE_VALIDATION.json"
...
COMMON_IMPLEMENTATION = [
    ...
    "scripts/validate_step084_organization_context.py",
...
COMMON_EVIDENCE = [
    ...
    "docs/evidence/STEP084_ARCHITECTURE_VALIDATION.json",
    "docs/evidence/STEP084_ORGANIZATION_CONTEXT_VALIDATION.json",
    "docs/evidence/STEP084_EXECUTION_PLANE_VALIDATION.json",
    "docs/evidence/STEP084_DISTRIBUTION_VALIDATION.json",
    "docs/evidence/STEP084_PYTHON_REGRESSION.json",
    "docs/evidence/STEP084_NON_PYTHON_VALIDATION.json",
    "docs/evidence/STEP084_INSTALLATION_VALIDATION.json",
    "docs/evidence/STEP084_WINDOWS_SUBPROCESS_PORTABILITY_VALIDATION.json",
    "docs/evidence/STEP084_ACCEPTANCE.json",
    "docs/evidence/STEP084_FRESH_ZIP_VALIDATION.json",
]
ISSUES = [f"OR-ISSUE-{number:03d}" for number in range(17, 75)]
...
def generate(output: Path = OUTPUT) -> dict[str, Any]:
    ...
    evidence = {
        ...
        "GATE-AMENDMENT-VALID": "constitution text unchanged; STEP084 adds read-only versioned Organization Context grounding without external synchronization or write authority",
        "GATE-NO-UNCLASSIFIED-TOPLEVEL-PACKAGE": "STEP084 Architecture 40/40",
        "GATE-NO-HARDCODED-OLD-PACKAGE-PATH": "executable legacy path coupling remains zero",
        "GATE-WHEEL-CONTENTS-EXACT": "STEP084 Installation validation and exact wheel payload PASS",
        "GATE-EDITABLE-INSTALL": "STEP084 fresh editable install and entrypoint PASS",
        ...
        "GATE-LAUNCHER-REGISTRY-COMPLETE": "STEP084 launcher registry v2 7/7",
        ...
        "GATE-FULL-REGRESSION": "STEP084 Python full regression and Node 14/14 PASS",
        "GATE-WINDOWS-LIVE": "inherited STEP081D Windows live 80/80; STEP084 adds no live authority",
        "GATE-FRESH-ZIP": "STEP084 Fresh ZIP validation PASS",
        "GATE-ISSUE-REGISTRY-COMPLETE": "OR-ISSUE-017 through OR-ISSUE-074 retained with recurrence gates",
    }
    ...
    traceability = [
        {
            ...
            "acceptance_checks": [
                ...
                "STEP084 Architecture 40/40",
                "STEP084 Organization Context 20/20",
                "STEP084 integrated acceptance PASS",
                "STEP084 full and Fresh regression PASS",
            ],
    ...
    payload: dict[str, Any] = {
        ...
        "validation_environment": {
            ...
            "step084_windows_deterministic": "PENDING_EXTERNAL_PRODUCT_PROMOTION_GATE",
