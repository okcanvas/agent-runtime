...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step090r1-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP090R1_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 12
STEP = "STEP090R1_ORGANIZATION_CONTEXT_MCP_TOOL_OUTPUT_PROTOCOL_AND_SHORT_LIST_TOOL_CHOICE_CLOSURE"
SCHEMA_VERSION = "okcanvas-step090r1-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step090r1-runtime-test-partition-v1",
        "step": STEP,
