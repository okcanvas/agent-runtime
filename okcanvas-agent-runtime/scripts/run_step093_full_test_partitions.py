...
EVIDENCE_ROOT = ROOT / "docs" / "evidence" / "step093r1-runtime-full-suite-partitions"
SUMMARY_PATH = ROOT / "docs" / "evidence" / "STEP093R1_FULL_RUNTIME_TEST_PARTITIONS.json"
PARTITION_COUNT = 18
STEP = "STEP093R1_RELATION_ROUTE_PROTOCOL_AND_LIVE_FALSE_POSITIVE_CLOSURE"
SCHEMA_VERSION = "okcanvas-step093r1-full-runtime-test-partitions-v1"
...
def run_partition(number: int) -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "okcanvas-step093-runtime-test-partition-v1",
        "step": STEP,
