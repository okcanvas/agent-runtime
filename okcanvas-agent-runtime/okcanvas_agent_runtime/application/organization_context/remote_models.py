...
class OrganizationContextReadState(StrEnum):
...
class OrganizationContextReadOperation:
    operation_id: str
    tool_name: str
    description: str
...
@dataclass(frozen=True)
class OrganizationContextReadPolicy:
    policy_id: str
    version: str
    capability_id: str
    root_agent_id: str
    ...
    operations: tuple[OrganizationContextReadOperation, ...]
    max_results: int
    production_sot: str
    policy_sha256: str
    ...
    def to_public_dict(self) -> dict[str, object]:
        return {
            "schema_version": "okcanvas-organization-context-read-policy-v1",
...
@dataclass(frozen=True)
class OrganizationContextReadReadiness:
    state: OrganizationContextReadState
    reasons: tuple[str, ...]
    ...
    def executable_now(self) -> bool:
        return self.state is OrganizationContextReadState.READY

    def to_public_dict(self) -> dict[str, object]:
        return {
            "schema_version": "okcanvas-organization-context-read-readiness-v1",
