...
"okcanvas-agent-runtime\.venv\Scripts\python.exe" scripts\workspace_python_bytecode_isolation.py okcanvas-agent-runtime\scripts\windows_entrypoint.py workspace-step007r1-live-acceptance %*
exit /b %ERRORLEVEL%
